...
Next, based on what you've learned from user research develop at least one task flow diagram for a key feature or task that will be completed using your application.

First sketch the diagram on paper in order to plan and refine the steps. Then transfer to digital form and export a PDF.

Submit your diagram using the corresponding submission in Moodle.
