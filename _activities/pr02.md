...
update your project purpose statement and features of the application. This could be the same as in Part 2-A, but might be updated based on your user research. *Include this on a separate page in your submission from the rest of the deliverable.*

Next, [read more about task flows here](http://0-proquest.safaribooksonline.com.library.cedarville.edu/book/-/9781592537808/chapter-4-getting-to-know-your-users/65?uicode=ohlink). This chapter from Pratt's text on Interaction Design used to be required reading in this class and is full of lots of good visual examples of deliverables.

Based on what you've learned from user research develop at least one task flow diagram for *a key feature or task* that will be completed using your application. This should be the single feature or small set of features that "sell" your app to potential users. You will flesh out one such full task flow in your final version of the application so use this as a planning step to envision the steps the user will go through to complete it.

First sketch the diagram on paper in order to plan and refine the steps. Then transfer to digital form and export a PDF.

Submit your diagram and updated purpose and features using the corresponding submission in Moodle.

### Deliverable D: Low-fidelity Wireframes
...
Then create larger low-fidelity wireframes (giving the impression of life-size) and bring them to class.

Also attach digital scans/images of your wireframes to the corresponding assignment in Moodle.
...
Use [this template](http://vcd-2600.philschanely.com/docs/style-tile-starter.sketch) to create style tiles for your application. Export this as a PNG you can include as the visual lexicon in the next component.
